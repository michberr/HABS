...
ggdraw() +
  ...
  draw_plot_label(c("A", "B", "C", "D", "E", "F"),  c(0.02, 0.02, 0.34, 0.34, 0.65, 0.65), c(0.97, 0.48, 0.97, 0.48, 0.97, 0.48), size = 14)

  
ggsave("../../Plots/Figure4.pdf", width = 15, height = 7) 
```
...
ggsave("../../Plots/acf.pdf", width = 12, height = 12) 

```
There is some temporal autocorrelation in the residuals so lets look at the
cv error. 
